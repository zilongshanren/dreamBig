...
## 维度五：公开 Web 媒体正文（来自 Bing 中文搜索 → 游民星空 / 小米游戏中心 / CSDN / 18183 / 游侠手游 等站点的正文片段）
（每段 ≤ 500 字。未出现游戏名的段落已过滤。引用这里的内容时
  在 rationale 里必须指向具体 domain，例如 "游民星空评测..."）
{web_sources_block}
